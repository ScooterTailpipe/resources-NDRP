Config = {
	...
	FrameworkResource = 'qb-core', -- (es_extended, qb-core and if you have changed your qb-core or es_extended to something just insert it here )
	...
	DispatchHighSpeed = true, -- If you want to enable dispatch notification set it to true
	DispatchLocked = true, -- If you want to enable dispatch ( if someone pass through border when its locked )
	Payment = false,	-- enable/disable payment
