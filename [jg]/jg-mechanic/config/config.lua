...
Config.MechanicLocations = {
  ...
  lscustoms = {
    ...
    locations = {
      {
        coords = vector3(-339.0, -1354.08, 31.45),
        size = 6.5,
        showBlip = true,
      },
      {
    ...
    carLifts = { -- only usable by employees
      vector4(-348.47, -1352.01, 31.45, 89.26),
      vector4(-347.64, -1367.66, 31.51, 178.63)
    },
    shops = {
      {
        name = "Servicing Supplies",
        coords = vector3(-349.66, -1330.24, 31.45),
        size = 2.0,
        usePed = false,
        ...
        items = {
          ...
          { name = "stancing_kit", label = "Stancing Kit", price = 0 },
      ...
      },
      {
        ...
        coords = vector3(-346.78, -1327.51, 31.45),
        size = 2.0,
        usePed = false,
        pedModel = "s_m_m_lathandy_01",
        marker = { id = 21, size = { x = 0.3, y = 0.3, z = 0.3 }, color = { r = 255, g = 255, b = 255, a = 120 }, bobUpAndDown = 0, faceCamera = 0, rotate = 1, drawOnEnts = 0 },
